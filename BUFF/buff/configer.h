...
typedef struct base
{
    Ptr<KNearest> model_R = StatModel::load<KNearest>("/home/zhangjiajun/Desktop/BUFF/buff/R.xml");
...
//    Mat DISTORTION_COEFF = (Mat_<double>(4, 1) <<-0.077012717292231 , 0.060457593355343 , 0 , 0);
    ...
    Mat CAMERA_MATRIX = (Mat_<double>(3, 3) <<1.367417385381001e+03 , 0 , 6.292012048184755e+02 ,
            0 ,  1.319795613288832e+03 , 4.926113215997334e+02 , 0 , 0 , 1);
    Mat DISTORTION_COEFF = (Mat_<double>(4, 1) <<-0.058870736173409 ,   0.228953310114482 , 0 , 0);
...
typedef enum State{
target,unlighted,shot,None
    } State;


typedef enum IoUType{
IoU,GIoU,DIoU,CIoU
    } IoUType;
